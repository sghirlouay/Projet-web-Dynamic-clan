...
<body>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="afficherComptes.html"> <i class="menu-icon fa fa-dashboard"></i>Accueil </a>
    ...
    <div id="right-panel" class="right-panel">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li><a href="afficherComptes.html">Accueil</a></li>
      ...
      <div id="afficher">
       <form  method="GET" action="lesComptes.php">
      </br>
       
    <center>  
</br>
   <button type="submit" style="background-color: #d1b3ff ; height: 100px ; width: 500px;">Gérer les Comptes</button>
    </center>
 </form>
...
<form  method="GET" action="pagination.php">
   ...
   <button type="submit" style="background-color: #d1b3ff; height: 100px ; width: 500px;">Afficher par pagination</button>
    </center>
 </form>
